...
export default function MainInfoText() {
  return (
    <main className='flex item-start justify-center md:item-start md:justify-start min-h-screen overflow-hidden c-space'>
      {/* Desktop view */}
      <div className='all-info'>
        ...
        <motion.span className='title text-center w-50'
       ><small>Frontend Developer</small> </motion.span>
     ...
     <motion.div className='flex flex-col items-center justify-center space-y-6 md:hidden min-h-screen'
      variants={variants}
        ...
        <img className='admin-img' src="" alt="" />
        </div> */}
    </main>
  );
};